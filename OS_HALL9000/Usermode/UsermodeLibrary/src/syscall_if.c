...
{
	return SyscallEntry(SyscallIdSetAffinity, Affinity);
}
...
{
	return SyscallEntry(SyscallIdGetCurrentPcpuId, PcpuId);
}
...
{
	return SyscallEntry(SyscallIdGetAffinity, Affinity);
}