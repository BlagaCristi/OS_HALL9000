...
// SyscallIdSetAffinity
//******************************************************************************
// Function:     SyscallSetAffinity
// Description:  Sets the affinity mask of the current thread.
// Returns:      STATUS
// Parameter:    IN BYTE Affinity
//******************************************************************************
STATUS
SyscallSetAffinity(
	IN  BYTE Affinity
...
// SyscallIdGetCurrentPcpuId
//******************************************************************************
// Function:     SyscallGetCurrentPcpuId
// Description:  Gets the Pcpu ID the current thread runs on.
// Returns:      STATUS
// Parameter:    OUT BYTE* PcpuId
//******************************************************************************
STATUS
...
// SyscallIdGetAffinity
//******************************************************************************
// Function:     SyscallGetAffinity
// Description:  Gets the affinity mask of the current thread.
// Returns:      STATUS
// Parameter:    OUT BYTE* Affinity
//******************************************************************************
STATUS
SyscallGetAffinity(
	OUT BYTE* Affinity
