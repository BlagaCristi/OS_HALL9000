...
// Parameter:    IN BYTE AffinityMask
...
//******************************************************************************
// Function:     ThreadSetPossibleRunnablePcpu
// Description:  Sets one possible runnable PCPU for the given thread based on
//				 its current affinity mask.
// Returns:      void
// Parameter:    IN PTHREAD PThread
//******************************************************************************
void
